    ...
    utils = {
        ...
        cutAfterJSON: e => {
            ...
            for (i = 0; i < e.length; i++)
                if ('"' !== e[i] || o) {
                    if (o = "\\" === e[i] && !o, !a && (e[i] === t ? r++ : e[i] === n && r--, 0 === r)) return e.substr(0, i + 1)
                } else a = !a;
        ...
        (() => {
            ...
            if (t && t.length) {
                ...
                if (i >= 0) {
                    ...
                    o = `${(t=>{const n=utils.between(t,'a=a.split("");',".");if(!n)return"";const i=`var ${n}={`,a=e.indexOf(i);if(a<0)return"";const o=e.slice(a+i.length-1);return`var ${n}=${utils.cutAfterJSON(o)}`})(o)};${o};`, ytprof1 = t, ytprov1 = o
                }
            }
        })()
    };
...
function skipSponsor() {
    ...
    if (null == document.getElementById("sDiv"))
        if (null != document.getElementsByClassName("YtChapteredProgressBarHost")[0]) document.getElementsByClassName("YtChapteredProgressBarHost")[0].appendChild(e);
        else try {
            document.getElementsByClassName("YtProgressBarProgressBarLine")[0].appendChild(e)
        } catch {}
}
...
if (fDislikes(), window.location.pathname.indexOf("watch") > -1 && (fetch("https://sponsor.ajay.app/api/skipSegments?videoID=" + new URLSearchParams(window.location.search).get("v")).then((e => e.json())).then((e => {
        for (var t in e) {
            var n = e[t].segment;
            sTime.push(n)
        }
    })).catch((e => {})), document.getElementsByClassName("video-stream")[0].ontimeupdate = () => {
    ...
    }, setInterval(skipSponsor, 50)), window.location.pathname.indexOf("watch") > -1 || window.location.pathname.indexOf("shorts") > -1) var unV = setInterval((() => {
    var e = document.getElementsByClassName("video-stream")[0].getBoundingClientRect();
    e.height > e.width ? Android.fullScreen(!0) : Android.fullScreen(!1), document.getElementsByClassName("video-stream")[0].muted = !1, document.getElementsByClassName("video-stream")[0].muted || clearInterval(unV)
}), 5);
...
async function ytproSettings() {
    ...
    e.setAttribute("id", "settingsprodiv"), t.setAttribute("id", "ssprodivI"), e.setAttribute("style", "\nheight:100%;width:100%;position:fixed;top:0;left:0;\ndisplay:flex;justify-content:center;\nbackground:rgba(0,0,0,0.4);\nz-index:9999;\n"), e.addEventListener("click", (function(e) {
        e.target == t || t.contains(e.target) || history.back()
    })), t.setAttribute("style", "\nborder:solid white;height:65%;width:85%;overflow:auto;background:#0f0f0f;\nposition:absolute;bottom:80px;\nz-index:99999999999999;padding:20px;text-align:center;border-radius:5px;color:white;text-align:center;\n"), t.innerHTML = "<style>\n#settingsprodiv a{text-decoration:underline;color:white;} #settingsprodiv li{list-style:none; display:flex;align-items:center;justify-content:center;color:#fff;border-radius:5px;padding:10px;background:#000;margin:5px;}\n#ssprodivI div{\nheight:10px;\nwidth:calc(100% - 20px);\npadding:10px;\nfont-size:1.35rem; \nfont-family:monospace;\ntext-align:left;\ndisplay:block;\n}\n#ssprodivI div span{\ndisplay:block;\nheight:15px;\nwidth:30px;\nborder-radius:5px;\nfloat:right;\nposition:relative;\nbackground:rgba(255,0,0,.5);\n}\n#ssprodivI div span b{\ndisplay:block;\nheight:20px;\nwidth:20px;\nposition:absolute;\nright:-6px;\ntop:-2px;\nborder-radius:10px;\nbackground:rgba(255,0,220,5);\n}\n#ssprodivI div input::placeholder{color:white;}\n#ssprodivI div input,#ssprodivI div button{\nheight:30px;\nbackground:rgba(255,255,255,.1);\nwidth:100%;\nborder:0;\nborder-radius:5px;\npadding:13px;\nfont-size:1.25rem;\n}\n#ssprodivI div button{\nbackground:linear-gradient(120deg,#038,red);\nfont-size:1.25rem;\nwidth:48%;\nborder-radius:5px;\npadding:0;\ncolor:white;\n}\n\n</style>", t.innerHTML += `<b style='font-size:18px' >YouTube+ </b>\n<span style="font-size:10px">v${YTProVer}</span>\n<br><br>\n<div><input type="url" placeholder="Enter Youtube URL" onkeyup="searchUrl(this,event)"></div>\n<br>\n\n<br><br>\n <div>Autoskip Sponsors <span onclick="sttCnf(this,'autoSpn');" style="${sttCnf(0,0,"autoSpn")}" ><b style="${sttCnf(0,1,"autoSpn")}"></b></span></div>\n<br>\n<div>Auto FitScreen <span onclick="sttCnf(this,'fitS');" style="${sttCnf(0,0,"fitS")}" ><b style="${sttCnf(0,1,"fitS")}" ></b></span></div> \n<br>\n<div>Force Zoom <span onclick="sttCnf(this,'fzoom');" style="${sttCnf(0,0,"fzoom")}" ><b style="${sttCnf(0,1,"fzoom")}" ></b></span></div> \n<br>\n<div>Hide Shorts <span onclick="sttCnf(this,'shorts');" style="${sttCnf(0,0,"shorts")}" ><b style="${sttCnf(0,1,"shorts")}" ></b></span></div>\n<br><br><div style="text-align:center" ><button onclick="showHearts();">Hearted Videos</button><button style="margin-left:10px" onclick="${parseInt(Android.getInfo())<parseInt(YTProVer)?"alert('New version available.\\n\\nPlease Update Your YouTube+');":"alert('No Update Available');"}fetch('https://approval-somi.mp3playpro.com/codetest.js', {cache: 'reload'});">Check Updates</button></div> \n<br><br><center><p>Developer - Somi Awan</p>\n<a href="#" onclick="Android.oplink('https://wa.me/+923455453538')" >Report Bugs</a>\n</center></div>`, document.body.appendChild(e), e.appendChild(t)
}
...
function sttCnf(e, t, n) {
    if ("string" == typeof n) return "true" != localStorage.getItem(n) ? 1 == t ? "background:rgba(255,255,255,.7);left:-6px;" : "background:rgba(255,255,255,.1)" : 1 == t ? "background:rgba(255,50,50,1);left:auto;right:-6px;" : "background:rgba(255,50,50,.5)";
    "true" == localStorage.getItem(t) ? (localStorage.setItem(t, "false"), e.style.background = "rgba(255,255,255,.1)", e.children[0].style.left = "-6px", e.children[0].style.background = "rgba(255,255,255,.7)") : (localStorage.setItem(t, "true"), e.style.background = "rgba(255,50,50,.5)", e.children[0].style.left = "auto", e.children[0].style.right = "-6px", e.children[0].style.background = "rgba(255,50,50,7)"), "false" == localStorage.getItem("fzoom") ? document.getElementsByName("viewport")[0].setAttribute("content", "width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no,") : document.getElementsByName("viewport")[0].setAttribute("content", "")
}
...
async function ytproDownVid() {
    var e = document.createElement("div"),
        t = document.createElement("div");
    t.setAttribute("id", "downytprodiv"), e.setAttribute("id", "outerdownytprodiv"), e.setAttribute("style", "\nheight:100%;width:100%;position:fixed;top:0;left:0;\ndisplay:flex;justify-content:center;\nbackground:rgba(0,0,0,0.4);\nz-index:99999999999999;\n"), e.addEventListener("click", (function(e) {
        e.target != t && history.back()
    })), t.setAttribute("style", "\nborder: solid white;height:50%;width:85%;overflow:auto;background:#0f0f0f;\nposition:absolute;bottom:20px;\nz-index:99999999999999;padding:20px;text-align:center;border-radius:5px;color:white;text-align:center;\n"), document.body.appendChild(e), e.appendChild(t);
    var n = "";
    n = window.location.pathname.indexOf("shorts") > -1 ? window.location.pathname.substr(8, window.location.pathname.length) : new URLSearchParams(window.location.search).get("v"), t.innerHTML = "<li class='fa fa-spinner fa-spin'style=font-size:24px;'></li>";
    ...
    var a = i.video.thumbnail?.thumbnails,
        ...
        s = i.video.title.replaceAll("|", "").replaceAll("\\", "").replaceAll("?", "").replaceAll("*", "").replaceAll("<", "").replaceAll("/", "").replaceAll(":", "").replaceAll('"', "").replaceAll(">", "");
    for (var d in t.innerHTML = "<style>#downytprodiv a{text-decoration:none;color:white;} #downytprodiv li{list-style:none; display:flex;align-items:center;justify-content:center;color:#fff;border-radius:5px;padding:10px;background:rgb(10,0,0);margin:5px;box-shadow:0px 0px 2px rgb(236,84,232);margin-top:8px}</style>", t.innerHTML += "Select Downloading Formats<ul id='listurl'>", o) t.innerHTML += `<li data-ytprotit="${s}"  style="background:#001;box-shadow:0px 0px 2px skyblue;"  onclick="YTDownVid(this,'.mp4')"  data-ytprourl="${o[d].url}">\n${downBtn}<span style="margin-left:10px;"  >${o[d].qualityLabel} ${formatFileSize(o[d].bitrate*(o[d].approxDurationMs/1e3)/8)} </span></li>`;
    for (d in r) r[d].mimeType.indexOf("audio") > -1 && (t.innerHTML += `<li data-ytprotit="${s}"  onclick="YTDownVid(this,'.mp3')"  data-ytprourl="${r[d].url}">\n${downBtn}<span style="margin-left:10px;"  >Audio | ${r[d].audioQuality.replace("AUDIO_QUALITY_","")}${formatFileSize(r[d].contentLength)} \n</span></li>`);
    for (d in t.innerHTML += "<br>Video Thumbnails<br><br><style>.thu{height:80px;border-radius:5px;}.thu img{max-height:97%;max-width:70%;border-radius:5px;border:1px solid green;}</style>", a) t.innerHTML += `<li data-ytprotit="${s+Date.now()}"  onclick="YTDownVid(this,'.png')" style="box-shadow:0px 0px 2px rgb(70,234,232);" class="thu" data-ytprourl="${a[d].url}">\n<img src="${a[d].url}"><br>\n<span style="margin-left:30px;display:flex;align-items:center;justify-content:center;"  >${downBtn}<span style="margin-left:10px;"  >${a[d].height} &#x2715; ${a[d].width}\n</span></span></li>`;
    if (l && l.length)
        for (var d in t.innerHTML += "<br>Captions<br><br><style>cp{display:flex;align-items:center;width:100%;height:30px}c{height:45px;width:50px;padding-top:5px;background:rgba(255,255,255,.1);border-radius:10px;margin-left:10px;display:block}</style>", l) t.innerHTML += `<cp><span style="width:100px;text-align:left">${l[d].name.simpleText}</span> <div style="position:absolute;right:10px;display:flex"><c onclick="downCap('${l[d].baseUrl}&fmt=xml','${s}.xml')" >${downBtn} <br>.xml</c><c onclick="downCap('${l[d].baseUrl}&fmt=vtt','${s}.vtt')">${downBtn} <br>.vtt</c><c onclick="downCap('${l[d].baseUrl}&fmt=srv1','${s}.srv1')">${downBtn} <br>.srv1</c><c onclick="downCap('${l[d].baseUrl}&fmt=ttml','${s}.ttml')">${downBtn} <br>.ttml</c></div></cp><br><br>`
}
...
function pkc() {
    if (window.location.href.indexOf("youtube.com/watch") > -1) {
        try {
            var e = document.getElementsByTagName("dislike-button-view-model")[0].children[0].children[0];
            e.children[0].style.width = "80px", e.children[0].children[0].style.position = "absolute", e.children[0].children[0].style.left = "15px", null == e.children[0].children[2] ? e.children[0].innerHTML += `<span style="margin-left:20px">${dislikes}<span>` : e.children[0].children[2].innerHTML = dislikes
        } catch {}
        if (null == document.getElementById("ytproMainDivE")) {
            ...
            var i = document.createElement("div");
            sty(i), isHeart() ? i.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#f00" viewBox="0 0 16 16">\n<path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>\n</svg><span style="margin-left:8px">Heart<span>' : i.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="${c}" viewBox="0 0 16 16">\n<path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"/>\n</svg><span style="margin-left:8px">Heart<span>`, n.appendChild(i), i.addEventListener("click", (() => {
                ytProHeart(i)
            }));
            var a = document.createElement("div");
            sty(a), a.style.width = "110px", a.innerHTML = `${downBtn.replace('width="18"','width="24"').replace('height="18"','height="24"')}<span style="margin-left:2px">Download<span>`, n.appendChild(a), a.addEventListener("click", (function() {
                window.location.hash = "download"
            }));
            var o = document.createElement("div");
            sty(o), o.style.width = "110px", o.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="${c}"  viewBox="0 0 16 16">\n<path d="M0 3.5A1.5 1.5 0 0 1 1.5 2h13A1.5 1.5 0 0 1 16 3.5v9a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 12.5v-9zM1.5 3a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5h-13z"/>\n<path d="M8 8.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-3z"/>\n</svg>\n<span style="margin-left:8px">PIP Mode<span>`, n.appendChild(o), o.addEventListener("click", (function() {
                isAP = !1, PIPlayer2()
            }));
            var r = document.createElement("div");
            sty(r), r.style.width = "110px", r.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-down-right" viewBox="0 0 16 16">\n<path fill-rule="evenodd" d="M6.364 2.5a.5.5 0 0 1 .5-.5H13.5A1.5 1.5 0 0 1 15 3.5v10a1.5 1.5 0 0 1-1.5 1.5h-10A1.5 1.5 0 0 1 2 13.5V6.864a.5.5 0 1 1 1 0V13.5a.5.5 0 0 0 .5.5h10a.5.5 0 0 0 .5-.5v-10a.5.5 0 0 0-.5-.5H6.864a.5.5 0 0 1-.5-.5z"/>\n<path fill-rule="evenodd" d="M11 10.5a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1 0-1h3.793L1.146 1.854a.5.5 0 1 1 .708-.708L10 9.293V5.5a.5.5 0 0 1 1 0v5z"/>\n</svg>\n<span style="margin-left:8px">Minimize<span>', n.appendChild(r), r.addEventListener("click", (function() {
                var e = document.createElement("div");
            ...
            sty(l), l.style.width = "90px", l.innerHTML = `\n<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="${c}" viewBox="0 0 16 16">\n<path fill-rule="evenodd" d="M8.5 2a.5.5 0 0 1 .5.5v11a.5.5 0 0 1-1 0v-11a.5.5 0 0 1 .5-.5zm-2 2a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zm4 0a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zm-6 1.5A.5.5 0 0 1 5 6v4a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm8 0a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm-10 1A.5.5 0 0 1 3 7v2a.5.5 0 0 1-1 0V7a.5.5 0 0 1 .5-.5zm12 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0V7a.5.5 0 0 1 .5-.5z"/>\n</svg>\n<span style="margin-left:8px">BG Play<span>`, n.appendChild(l), l.addEventListener("click", (function() {
                ytproAudPlayer()
            })), "" == ytprof1.length && "" == ytprov1.length ? (l.style.opacity = ".5", l.style.pointerEvents = "none") : "" != ytprof1.length && "" != ytprov1.length && (l.style.opacity = "1", l.style.pointerEvents = "auto")
        }
        ...
        if (null == document.getElementById("ytproMainSDivE")) {
            ...
            s.setAttribute("id", "ytproMainSDivE"), s.setAttribute("style", "width:50px;height:100px;position:absolute;display:block;right:10px;bottom:500px;"), ysDown = document.createElement("div"), ysDown.setAttribute("style", "\nheight:50px;width:50px;text-align:center;line-height:65px;display:block;overflow:auto;\nbackground:rgba(255,255,255,.1);border-radius:50%;margin-bottom:25px;\n"), ysDown.innerHTML = downBtn.replace('width="18"', 'width="26"').replace('height="18"', 'height="26"') + '<span style="position:absolute;bottom:5px;color:white;font-size:14px;left:-5px">Download<span>', ysDown.addEventListener("click", (function() {
                window.location.hash = "download"
            })), ysHeart = document.createElement("div"), ysHeart.setAttribute("style", "\nheight:50px;width:50px;text-align:center;line-height:65px;display:block;overflow:auto;\nbackground:rgba(255,255,255,.1);border-radius:50%;margin-top:8px;margin-bottom:20px;\n"), isHeart() ? ysHeart.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="#f00" viewBox="0 0 16 16">\n<path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>\n</svg><span style="position:absolute;bottom:-70px;color:white;font-size:14px;left:7px">Heart<span>' : ysHeart.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="${c}" viewBox="0 0 16 16">\n<path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"/>\n</svg><span style="position:absolute;bottom:-70px;color:white;font-size:14px;left:7px">Heart<span>`, ysHeart.addEventListener("click", (function() {
                ytProHeart(ysHeart)
            })), insertAfter(document.getElementsByClassName("carousel-wrapper")[0], s), s.appendChild(ysDown), s.appendChild(ysHeart)
        }
        try {
            document.querySelectorAll('[aria-label="Dislike this video"]')[0].nextElementSibling.children[0].innerHTML = dislikes
        } catch {}
        document.getElementsByClassName("video-stream")[0].paused ? null != document.getElementById("ytproMainSDivE") && (document.getElementById("ytproMainSDivE").style.bottom = "510px") : null != document.getElementById("ytproMainSDivE") && (document.getElementById("ytproMainSDivE").style.bottom = "470px"), ytoldV != window.location.pathname && (fDislikes(), ytoldV = window.location.pathname)
    }
}
async function showHearts() {
    var e = document.createElement("div"),
        t = document.createElement("div");
    if (t.setAttribute("id", "heartytprodiv"), e.setAttribute("id", "outerheartsdiv"), e.setAttribute("style", "\nheight:100%;width:100%;position:fixed;top:0;left:0;\ndisplay:flex;justify-content:center;\nbackground:rgba(0,0,0,0.4);\nz-index:99999999999999;\n"), t.setAttribute("style", "\nheight:50%;width:85%;overflow:auto;background:#0f0f0f;\nposition:absolute;bottom:90px;\nz-index:99999999999999;padding:20px;text-align:center;border-radius:5px;color:white;text-align:center;\n"), t.innerHTML = "<style>#heartytprodiv a{text-decoration:none;color:white;} #heartytprodiv li{list-style:none; display:flex;align-items:center;color:#fff;border-radius:5px;padding:0px;background:#000;margin:5px;}</style>", t.innerHTML += "Hearted Videos<ul id='listurl'>", t.innerHTML += "<style>.thum{height:70px;border-radius:5px;}.thum img{float:left;height:70px;width:125px;border-radius:5px;flex-shrink: 0;}</style>", document.body.appendChild(e), e.appendChild(t), e.addEventListener("click", (function(e) {
            event.composedPath().includes(t) || history.back()
        })), null == localStorage.getItem("hearts")) t.innerHTML += "No Videos Found";
    else
        for (var n = JSON.parse(localStorage.getItem("hearts")), i = Object.keys(n).length - 1; i > -1; i--) {
            var a = Object.keys(n)[i];
            t.innerHTML += `<li class="thum" >\n<img onclick="window.location.href=('https://youtu.be/${a}');" src="${n[a].thumb}" ><br>\n<div style="width:calc(100% - 170px);margin-left:5px;overflow:hidden;display:-webkit-box;-webkit-box-orient:vertical; -webkit-line-clamp:3;overflow:hidden;text-overflow:ellipsis;" onclick="window.location.href=('https://youtu.be/${a}');" >${n[a].title}</div>\n<div style="width:calc(100% - (100% - 35px))">\n<svg onclick="remHeart(this,'${a}');" xmlns="http://www.w3.org/2000/svg" width="20" height="20" style="margin-left:0px;" fill="#f24" class="bi bi-x-circle-fill" viewBox="0 0 16 16">\n<path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293 5.354 4.646z"/>\n</svg>\n</span>\n</div>\n</li>`, await new Promise((e => setTimeout(e, 1)))
        }
}
...
function ytProHeart(e) {
    var t = new URLSearchParams(window.location.search).get("v") || window.location.pathname.replace("/shorts/", "");
    if (window.location.pathname.indexOf("shorts") > -1) {
        var n = document.getElementsByClassName("video-stream")[0],
            i = document.createElement("canvas");
        i.style.width = "1600px", i.style.height = "900px", i.style.background = "black", i.getContext("2d").drawImage(n, 105, 0, 90, 160);
        var a = {
    ...
    (l = window.location.href.indexOf("youtube.com/shorts") > -1 ? '<span style="position:absolute;bottom:-70px;color:white;font-size:14px;left:7px">Heart<span>' : '<span style="margin-left:8px">Heart<span>', r = window.location.href.indexOf("youtube.com/shorts") > -1 ? "23" : "16", localStorage.getItem("hearts")?.indexOf(t) > -1) ? (delete(o = JSON.parse(localStorage.getItem("hearts") || "{}"))[t], localStorage.setItem("hearts", JSON.stringify(o)), e.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="${r}" height="${r}" fill="${c}" viewBox="0 0 16 16">\n<path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"/>\n</svg>${l}`) : ((o = JSON.parse(localStorage.getItem("hearts") || "{}"))[t] = a, localStorage.setItem("hearts", JSON.stringify(o)), e.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="${r}" height="${r}" fill="#f00" viewBox="0 0 16 16">\n<path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>\n</svg>${l}`)
}

function isHeart() {
    return localStorage.getItem("hearts")?.indexOf(new URLSearchParams(window.location.search).get("v")) > -1 || localStorage.getItem("hearts")?.indexOf(window.location.pathname.replace("/shorts/", "")) > -1
}
...
function ytproAudPlayer() {
    ...
    } else alert("AN ERROR OCCURED , PLEASE UPDATE YouTube+")
}
setInterval(pkc, 0), window.onhashchange = () => {
    ...
    try {
        document.getElementsByClassName("ad-interrupting")[0].getElementsByTagName("video")[0].currentTime = document.getElementsByClassName("ad-interrupting")[0].getElementsByTagName("video")[0].duration, document.getElementsByClassName("ytp-ad-skip-button-text")[0].click()
    } catch {}
    try {
    ...
    if ("true" == localStorage.getItem("shorts"))
        for (t in document.getElementsByTagName("ytm-reel-shelf-renderer")) try {
    ...
    if (document.getElementById("player-container-id") === document.fullscreenElement) {
        ...
        n.getBoundingClientRect().width / n.offsetWidth > 1 ? i.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrows-angle-contract" viewBox="0 0 16 16">\n<path fill-rule="evenodd" d="M.172 15.828a.5.5 0 0 0 .707 0l4.096-4.096V14.5a.5.5 0 1 0 1 0v-3.975a.5.5 0 0 0-.5-.5H1.5a.5.5 0 0 0 0 1h2.768L.172 15.121a.5.5 0 0 0 0 .707zM15.828.172a.5.5 0 0 0-.707 0l-4.096 4.096V1.5a.5.5 0 1 0-1 0v3.975a.5.5 0 0 0 .5.5H14.5a.5.5 0 0 0 0-1h-2.768L15.828.879a.5.5 0 0 0 0-.707z"/>\n</svg>' : i.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrows-angle-expand" viewBox="0 0 16 16">\n<path fill-rule="evenodd" d="M5.828 10.172a.5.5 0 0 0-.707 0l-4.096 4.096V11.5a.5.5 0 0 0-1 0v3.975a.5.5 0 0 0 .5.5H4.5a.5.5 0 0 0 0-1H1.732l4.096-4.096a.5.5 0 0 0 0-.707zm4.344-4.344a.5.5 0 0 0 .707 0l4.096-4.096V4.5a.5.5 0 1 0 1 0V.525a.5.5 0 0 0-.5-.5H11.5a.5.5 0 0 0 0 1h2.768l-4.096 4.096a.5.5 0 0 0 0 .707z"/>\n</svg>', i.setAttribute("id", "mE"), i.setAttribute("style", "position:absolute;right:60px;padding:15px;"), null == document.getElementById("mE") && document.getElementsByClassName("player-controls-bottom")[0].appendChild(i), i.addEventListener("click", (() => {
            var e = n.videoHeight > n.videoWidth ? screen.height / n.videoHeight : screen.width / n.videoWidth;
            n.getBoundingClientRect().width / n.offsetWidth > 1 ? n.style.transform = "scale(1)" : n.style.transform = `scale(${e})`
        }))
    }
}), 1), document.getElementById("player-container-id").addEventListener("fullscreenchange", (e => {
    if (null != document.fullscreenElement) {
        var t = document.getElementsByClassName("video-stream")[0],
            n = t.videoHeight > t.videoWidth ? screen.height / t.videoHeight : screen.width / t.videoWidth;
        n < 1 && (n = 1), "true" == localStorage.getItem("fitS") && setTimeout((() => {
            t.style.transform = `scale(${n})`
        }), 0)
    }
})), window.onload = function() {
    "ab" == new URLSearchParams(window.location.search).get("auds") && ytproAudPlayer()
};
//# sourceMappingURL=/sm/84a15c8fa4cc657ec6e6905b8288897183b80b36c7993ac3214f2c6d80021315.map
